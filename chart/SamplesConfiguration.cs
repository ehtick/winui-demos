...
namespace Syncfusion.ChartDemos.WinUI
{
    public class SamplesConfiguration
    {
        public SamplesConfiguration()
        {
            ...
            DemoInfo dataPreprocessing = new DemoInfo()
            {
                Name = "Data Preprocessing",
                Category = "Smart Components",
                DemoType = DemoTypes.None | DemoTypes.AISamples,
                DemoView = typeof(Views.DataCleaning_Preprocessing),
                ShowInfoPanel = true,
                Description = "This sample showcases the data preprocessing using AI"
            };

            List<Documentation> datapreprocessingDocumentation = new List<Documentation>()
            {
                new Documentation(){ Content = "Line Series API Reference", Uri = new Uri("https://help.syncfusion.com/cr/winui/Syncfusion.UI.Xaml.Charts.LineSeries.html")},
                new Documentation(){ Content = "Line Series Documentation", Uri = new Uri("https://help.syncfusion.com/winui/cartesian-charts/line")},
            };

            dataPreprocessing.Documentation.AddRange(datapreprocessingDocumentation);
            ...
            DemoInfo logarithmicSample = new DemoInfo()
            {
                Name = "Logarithmic",
                Category = "Axis",
                DemoType = DemoTypes.None,
                DemoView = typeof(Views.LogarithmicAxis),
                ShowInfoPanel = true,
                Description = "This sample showcases the logarithmic axis, which is used to plot and visualize Logarithmic values."
            };

            List<Documentation> logarithmicDocumentation = new List<Documentation>()
            {
               new Documentation(){ Content = "Logarithmic Axis API Reference", Uri = new Uri("https://help.syncfusion.com/cr/winui/Syncfusion.UI.Xaml.Charts.LogarithmicAxis.html")},
               new Documentation(){ Content = "Logarithmic Axis Documentation", Uri = new Uri("https://help.syncfusion.com/winui/cartesian-charts/axis/types#logarithmic-axis")},
            };
            logarithmicSample.Documentation.AddRange(logarithmicDocumentation);
